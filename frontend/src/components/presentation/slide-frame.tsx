...
type SlideFrameProps = {
  ...
  onPrev: () => void;
  onNext: () => void;
  /** Phase 6 — hide all chrome for `?mode=record`. */
 ...
 * with it. `chromeHidden` collapses the entire chrome for record mode
 * (no top strip, no bottom strip, no click-hint) — the slide body still
 * absorbs keyboard / click overrides during recording in case the
 * operator wants to interrupt a take.
 */
